 ...
 * 
 */
@WebServiceClient(name = "ReservationServiceImplService", targetNamespace = "http://services.ws.companyreserv.company.broker.bb.pl/", wsdlLocation = "http://localhost:8080/company/ws/reservations/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATIONSERVICEIMPLSERVICE_QNAME = new QName("http://services.ws.companyreserv.company.broker.bb.pl/", "ReservationServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/company/ws/reservations/?wsdl");
    ...
    public ReservationService getReservationServiceImplPort() {
        return super.getPort(new QName("http://services.ws.companyreserv.company.broker.bb.pl/", "ReservationServiceImplPort"), ReservationService.class);
    }
    ...
    public ReservationService getReservationServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ws.companyreserv.company.broker.bb.pl/", "ReservationServiceImplPort"), ReservationService.class, features);
    }
